...
4. **App domains** — frontend host (e.g. Vercel) and API host (e.g. gastrocycle.com).
...
- UAT can stay in **Development** with testers only.
- Production requires **Live** + approved scopes.
